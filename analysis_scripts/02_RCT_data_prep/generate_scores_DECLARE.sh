### script for estimating genetic scores in DECLARE ##
cd ./data/rct_data
...
#genotype file
pfile=DECLARE.for_scores
hwe_file=DECLARE_hwe_fail_snp_list 
...
for score in $scores; do
    out="DECLARE_$(echo $score | sed 's/_pst_eff_a1_b0.5_phiauto.txt.gz/_prscs/g' | sed 's/_prscs_prscs/_prscs/g')"
...
out=DECLARE_NASH_biomarker_GRS
...
for score in $scores; do
    out="DECLARE_$(echo $score | sed 's/.2018.txt//g')"
