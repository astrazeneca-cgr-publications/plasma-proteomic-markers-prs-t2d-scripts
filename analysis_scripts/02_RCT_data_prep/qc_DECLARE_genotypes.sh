#script for estimating PCs and performing QC on DECLARE genotype data
...
bfile=./data/DECLARE/genotype-quality-control-DECLARE.hg19/data/DECLARE.hg19.noQC
...
${plink2} --bfile ${bfile} \
      ...
      --maf 0.005 \
      --geno ${snp_miss_h} \
      --out ./data/DECLARE/for_imputation/DECLARE-CLEAN.RELS-updated-chr${chrname}
